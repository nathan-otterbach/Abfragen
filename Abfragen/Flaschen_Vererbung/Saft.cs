...
namespace Flaschen_Vererbung
{
    public class Saft : Flasche
    {
        ...
        public Saft() { localIndex = Interlocked.Increment(ref counter); }

        public Saft(int maxmenge, int fuellmenge, int leergewicht, int zuckergehalt) : this()
        {
